<!-- src/components/ProcessTable.vue -->
<template>
	<div>
			...
			<el-table-column label="Műveletek" width="200">
				<template #default="scope">
					...
					<el-tooltip placement="top">
						...
						<el-button
							@click="$emit('edit', scope.row.processId)"
							type="primary"
							circle
							size="large"
						>
					...
					<el-tooltip placement="top">
						...
						<el-button
							@click="$emit('delete', scope.row.processId)"
							type="danger"
							circle
							size="large"
						>
...
export default {
  ...
  setup(props, { emit }) {
	...
	const paginatedData = computed(() => {
	  ...
	  return (props.processes || []).slice(start, start + pageSize)
	})
	...
	const filtered = computed(() => props.processes || [])
